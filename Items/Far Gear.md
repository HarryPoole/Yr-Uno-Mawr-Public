...
While attuned to this device, you have a +1 bonus to Charisma saving throws, and you have advantage on Intimidation checks.
...
**Unnatural Bane**. You can cast the [bane](https://www.dndbeyond.com/spells/2009-bane) spell (save DC 15), which affects any number of creatures within range for 1 minute. Once you use this feature of the [[Far Gear]], it cannot be used again until the next dawn.
